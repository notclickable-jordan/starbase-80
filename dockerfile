...
ENV TITLECOLOR="black"
ENV TITLECOLORDARK="rgb(226 232 240)"
ENV CATEGORYCOLOR="rgb(71 85 105)"
ENV CATEGORYCOLORDARK="rgb(226 232 240)"
ENV LINKCOLOR="black"
ENV LINKCOLORDARK="rgb(226 232 240)"
ENV DESCRIPTIONCOLOR="rgba(0, 0, 0, 0.5)"
ENV DESCRIPTIONCOLORDARK="rgba(255, 255, 255, 0.5)"
ENV THEME="auto"
ENV NEWWINDOW="true"
ENV HOVER="none"
